...
int main(int argc, char* argv[])
{
	...
	/// Store every word from Dictionary.txt into a data collection list dictionary.
	ifstream inFile;
 ...
 * Upon determining the length of the initial and target words, n, prune the dictionary such that a new version of it is created, containing only words of n length.
 * This will help to speed up any searches through the dictionary.
 * @param inFile : The dictionary text file which should be pruned to contain only words of length wordLength.
 * @param dictionary : The list to store all words from the pruned dictionary.
 * @param wordLength : The length of the initial and target words.
 */
void pruneDictionary(ifstream& inFile, list<string> * dictionary, int * wordLength)
{
	string word;
...
list<string>* playWordGame(list<string> * dictionary, string& initialWord, string& targetWord)
{
	// As the Breadth-First Search Algorithm utilizes a FIFO structure, define an empty stack variable to represent the fringe.
